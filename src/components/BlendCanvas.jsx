...
const EMOTIONS = [
  {id: 'angry', name: '生氣', emoji: '😠', src: '/emo-monster/assets/emotions/angry.png'},
  {id: 'sad', name: '難過', emoji: '😢', src: '/emo-monster/assets/emotions/sad.png'},
  {id: 'happy', name: '快樂', emoji: '😊', src: '/emo-monster/assets/emotions/happy.png'}
]
