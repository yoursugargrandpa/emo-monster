...
const EMOTIONS = [
  {id: 'angry', name: '生氣', src: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAIAAADYYG7QAAAAOElEQVR42u3OMQ0AAAgDsPmd/xtcEI4mFdBM+0qEhISEhISEhISEhISEhISEhISEhISEhISEhO4sqkt98bvP0qoAAAAASUVORK5CYII='},
  {id: 'sad', name: '難過', src: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAIAAADYYG7QAAAAOUlEQVR42u3OQQ0AAAgEoOtrU0tpC+eDjQCkel6JkJCQkJCQkJCQkJCQkJCQkJCQkJCQkJCQkNCdBZLc1R7zQO9bAAAAAElFTkSuQmCC'},
  {id: 'happy', name: '快樂', src: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAIAAADYYG7QAAAAOklEQVR42u3OQQ0AAAgEoCtm/wjG0RbOBxsByHS9EiEhISEhISEhISEhISEhISEhISEhISEhISGhOwtU9qwPAmpx3AAAAABJRU5ErkJggg=='}
]
